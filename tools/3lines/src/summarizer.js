...
import { validateStructuredCoverage } from './structure.js?v=1.6.0';
import { composeThreeLines } from './composer.js?v=1.6.0';
...
export { composeThreeLines } from './composer.js?v=1.6.0';
