...
import { validateStructuredCoverage } from './structure.js?v=1.5.0';
import { composeThreeLines } from './composer.js?v=1.5.0';
...
export { composeThreeLines } from './composer.js?v=1.5.0';
