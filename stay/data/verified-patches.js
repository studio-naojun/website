  ...
  patches: [
    ...
    },
    {
      ...
      verifications: {
        ...
        'families.booking_age': { label: '子どもの予約上の年齢区分', status: 'verified', source_label: 'Hilton official hotel page', source_url: 'https://www.hilton.com/en/hotels/tyotbtw-hilton-tokyo-bay/', checked_at: '2026-08-07', note: '6歳以上は大人として予約人数に含めるよう公式ページに記載。添寝無料条件そのものとは別項目として保持。' },
